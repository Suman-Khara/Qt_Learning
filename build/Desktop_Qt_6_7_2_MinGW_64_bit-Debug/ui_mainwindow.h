...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        DDA_Button = new QPushButton(centralwidget);
        DDA_Button->setObjectName("DDA_Button");
        DDA_Button->setGeometry(QRect(770, 270, 141, 29));
        Bresenham_Button = new QPushButton(centralwidget);
        Bresenham_Button->setObjectName("Bresenham_Button");
        Bresenham_Button->setGeometry(QRect(770, 420, 141, 29));
        DDA_Time = new QLabel(centralwidget);
        DDA_Time->setObjectName("DDA_Time");
        DDA_Time->setGeometry(QRect(940, 270, 221, 31));
        Bresenham_Time = new QLabel(centralwidget);
        Bresenham_Time->setObjectName("Bresenham_Time");
        Bresenham_Time->setGeometry(QRect(940, 420, 221, 31));
